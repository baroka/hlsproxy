...
# Install HLS Proxy
RUN curl -O https://www.hls-proxy.com/downloads/8.0.7/hls-proxy-8.0.7.linux-x64.zip && \
    unzip hls-proxy-8.0.7.linux-x64.zip

RUN rm hls-proxy-8.0.7.linux-x64.zip
